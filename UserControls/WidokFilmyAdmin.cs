...
{
    public partial class WidokFilmyAdmin : UserControl
    {
        Użytkownik użytkownik;

        public WidokFilmyAdmin()
        {
            InitializeComponent();
        ...
        public WidokFilmyAdmin(Użytkownik użytkownik)
        {
            InitializeComponent();
        ...
        {
            Form form = new Form();
            WidokSeanseAdmin widokSeanse = new WidokSeanseAdmin(użytkownik);
        ...
        {
            Form form = new Form();
            WidokSeanseAdmin widokSeanse = new WidokSeanseAdmin(lokalizacja, filmID, użytkownik);
